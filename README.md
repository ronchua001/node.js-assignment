# How to start
Run 1, then 2 or 3, database populated by initialised by javascript/database/DDL.sql (some dummy data was inserted) for testing purposes. Using NodeJS v15.4.0
...
## Prerequisites
- NodeJS v15.4.0   (using this version)
- Docker
